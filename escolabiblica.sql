...
--
-- Host: localhost:8889
-- Generation Time: 23-Ago-2016 às 22:39
...
--
-- Estrutura da tabela `alunos_classes`
--

CREATE TABLE `alunos_classes` (
...
--
-- Extraindo dados da tabela `alunos_classes`
--

INSERT INTO `alunos_classes` (`id`, `aluno_id`, `classe_id`, `created`, `modified`) VALUES
...
INSERT INTO `estudos` (`id`, `nome`, `created`, `modified`) VALUES
...
INSERT INTO `lideres` (`id`, `usuario_id`, `created`, `modified`) VALUES
...
CREATE TABLE `pgs` (
  ...
  `anfitriao_id` int(11) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL
...
INSERT INTO `pgs` (`id`, `nome`, `endereco`, `fundacao`, `lider_id`, `secretario_id`, `anfitriao_id`, `created`, `modified`) VALUES
(2, 'meu novo pg', 'asdasdasd', '2015-06-23', 1, NULL, NULL, '2015-06-23 13:36:59', '2015-06-23 13:43:10'),
(3, 'dasdasd', 'asdasdasd', '2015-06-23', 0, NULL, NULL, '2015-06-23 13:37:16', '2015-06-23 13:37:16'),
(4, 'rwerwe', 'rwerwerwer', '2015-06-23', NULL, NULL, NULL, '2015-06-23 13:37:48', '2015-06-23 13:37:48');
...
--
-- Indexes for table `alunos_classes`
--
ALTER TABLE `alunos_classes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `aluno_id` (`aluno_id`),
  ADD KEY `sala_id` (`classe_id`);
...
ALTER TABLE `pgs`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `anfitriao_id` (`anfitriao_id`);
...
--
-- AUTO_INCREMENT for table `alunos_classes`
--
ALTER TABLE `alunos_classes`
